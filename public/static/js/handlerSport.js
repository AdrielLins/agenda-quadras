...
function registerSportByAdm() {
    ...
    $.ajax({
        ...
        if (!res) {
            ...
            alertify.alert('Esporte criado com sucesso!', function () { alertify.success(window.location.href = "./manageSport.html"); });
        }
    }).fail(function (err) {
...
function updateSport() {
    ...
    $.ajax({
        ...
        if (!res) {
            ...
            alertify.alert('Esporte atualizado com sucesso!', function () { alertify.success(window.location.href = "./manageSport.html"); });
        }
    }).fail(function (err) {
        alertify.alert('Erro', 'Não foi possível realizar esta solicitação no momento.');
        return
